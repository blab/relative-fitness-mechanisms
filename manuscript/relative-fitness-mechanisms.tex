...
We fit a transformer-based model to data from (insert number) states in the United States between (start date) and (end date).
...
% Selective pressure
% TODO:: ...enables prediction of growh rate from sequence counts
% TODO:: ... compatiable with all models which estimate frequency and relative fitness 
