...
\begin{abstract}
    Since the emergence of COVID-19, emerging SARS-CoV-2 variants have caused repeated outbreaks.
    Scientists have tracked these viral variants through phylogenetic approaches, classifying them into clades and modeling their frequencies over time to estimate their fitness advantages.
    However, these models typically cannot be interpreted at the level of transmission directly.

    We develop a general theory for existing frequency models and interpret fitness through compartment models of infectious disease, addressing trade-offs between immune escape and increased transmissibility using frequency data.
