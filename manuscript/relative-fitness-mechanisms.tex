...
Over the course of the COVID-19 pandemic, there have been several large waves of infections globally. \cite{tegally2021detection} (DETAILS HERE) %TODO: Cite Alpha, BA.2.12.1, BA.2.75, and Omicron papers
...
This phenomenon is consistent with antigenic evolution and is observed in several other viruses such as [INSERT CITATIONS]. %TODO: Who to cite here?
...
This framework includes various existing methods for analyzing frequency data such as Huddleston et al, Obermyer et al, multinomial logistic regression, ...  %TODO: Cite John, Obermyer..., ...
...
Multi-strain models of epidemics have ... %TODO: CIte Gog and Grenfell, maybe Frank Wen's work, Antigen?
...
%: Developed a simple framework for thinking about relative fitness estimation
%: We showed the utility of mechanistic models in informing variant turnover
%: Suggests that we may improve forecasts model by incorporating information about assumed transmission mechanism
%: Suggests that there are limits to our ability to attribute dynamics to particular mechanisms even if assumed mechanisms are predictive

% We developed methods for forecasting and predicting relative fitnesses in the short term
% Extensions include adapting the Hilbert Space Gaussian Process models to non-stationary kernels for scalable inference


%Limitations:

%% Latent variable methods might not work in high variant low time regime and are not strictly real
%% Though the structure is from immune escape models this does not mean that it is only capturing escape
...
%%TODO: Deterministic models
    % Not all variants succeed, these models do not account for the appearance of genetic variants
    % Probabilistically speaking, we do not know the rate at which escape variants are generated versus transmissibility increases

%%TODO: Further research:
    % Should take into account these mechanisms for individual tasks such as prediction .etc
    % Should extend to more complicated models of transmission including stochastic models .etc
    % Simulation methods exist like this and explicit modeling of antigenic space (Cobey, Lassig)
