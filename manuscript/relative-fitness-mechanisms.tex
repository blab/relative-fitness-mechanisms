...
\begin{abstract}
    ...
    We use these models to highlight several complications when analyzing the frequency dynamics of infectious disease variants, namely the difficulty in discovering fitness mechanisms such as immune escape or increased transmissibility from frequency data alone.
    ...
    Motivated by this work, we develop an approximate Gaussian process method for estimating time-varying fitness of SARS-CoV-2 variants.
    ...
    Using this selective pressure metric, we are then able to develop a predictive model of epidemic growth rate from selective pressure.
    
    Finally, we develop a latent immunity space model for relative fitness which estimates pseudo-escape rates for variants and pseudo-immunity proportions for populations.
    Applying this model to publicly available SARS-CoV-2 sequences in the United States, we estimate a pseudo-immunity landscape for SARS-CoV-2 variants and show our embedding are correlated with recent titer data.
...
These large epidemic waves have been typically driven by emerging variants of SARS-CoV-2.

%TODO: First waves driven by intrinsic transmissibility
%TODO: Now similar to influenza likely hypothesis is antigenic evolution and immune escape
%TODO: This will be useful for discriminating between two major hypotheses.
...
Early mutations and viral variants such as D614G, Alpha, Beta, Gamma, Delta and their associated infection waves were largely driven by increases in intrinsic transmissibility which may be expected when there is lower population immunity.
%TODO: Citations: Muller/Wagner, Bloom lab
However, after the emergence of the Omicron variant, later variants such as XBB, EG.5.1, JN.1 and their associated waves appear to be driven by immune escape as evidenced through ...
% \cite{Bekliz2024}, \cite{Cao2021}, \cite{Cao2022}, \cite{Jian2023}
%TODO: Citations: Bloom lab, Cao, ...
...
This later phenomenon of rapid viral population turnover is consistent with antigenic evolution and is observed in several other viruses such as seasonal influenza, although SARS-CoV-2 is currently remains an outlier in terms of pace of evolution \cite{Koel2013, Bedford2014, kistler2023atlas}.
...
%TODO: Be more concrete in differentiating betwen escape, transmissibility
...
%\tbc{I always think of the ordering here as intrinsic transmissibility then immune escape just based on what we empirically observed for SARS-CoV-2 and generally expect for emerging pathogens --- first host adaptation, then antigenic pressure}
...
%TODO: Happy to remove this for now, this was primarily anticipating comparisons to SWP's work which looks at how these relative fitnesses might be affected by differences in timing between infections.
...
% MF: I've added a section that shows how they relate directly.
...
We find that though relative fitness trajectories will share the same decreasing shape, they may decline at diffrent rates depending on the mechanism.
...
%TODO: We'll replace this with section that compares initial growth rates for different mechanisms assuming same starting relative fitness
%TODO: This is a direct application of the two-variant system. We can compute the relationship btw relative fitness for different mechanisms.
