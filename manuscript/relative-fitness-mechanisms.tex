...
\begin{abstract}
    ...
    These models of frequency dynamics enable inference of variant fitness advantages, however, these models are typically divorced from a direct interpretation at the level of transmission, limiting their utility.

    In this paper, we derive existing frequency dynamic models from exponentially growing populations and extend them to show that relative fitness of variants can be interpreted in terms of compartment models of infectious diseases.
    We use these models to highlight several complications when analyzing the frequency dynamics of infectious disease variants, namely the difficulty in discovering transmission mechanisms such as immune escape or increased transmissibility from frequency data alone.
