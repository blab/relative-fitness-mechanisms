...
\begin{figure}[h]
    ...
    \caption{
      ...
      (C) Co-occurence matrix between learned immune clusters and infection histories.
...
A co-occurrence analysis links learned clusters to reported exposure histories (Fig.~\ref{fig:latent_immune_structure}C).
