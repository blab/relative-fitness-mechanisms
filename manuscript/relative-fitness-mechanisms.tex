...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{./figures/latent-immune-structure.png}
    \caption{
...
To assess variant-level escape against each cluster, we analyze the escape burden (the negative of the predicted titer) on our 
