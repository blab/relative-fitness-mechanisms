...
%TODO: Specific examples: Figgins, Piantham, Susserwain, , no lineage assigment model, Noemie
...
Beginning again from our assumption of inhomogeneous exponential growth, we can write a differential equation for the total prevalence as

\begin{align*}
    \frac{d I}{d t} &= \sum_{v} r_{v}(t) I_{v}(t)\\ 
...
Re-writing the average in terms of some base exponential growth rate and the relative fitnesses, so that $\overline{r}(t) = \sum_{v} \lambda_{v}(t)f_{v}(t) + r(t)$.
We can now look at the rate of change in the derivative.
