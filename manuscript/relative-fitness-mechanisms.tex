...
To generate pseudo-estimates of this latent factors, we develop and implement our method for latent factors models of relative fitness (see Materials and Methods).
...
We generate sequence counts for 14 countries and 41 variants in this period.
\tbc{Which period? Again, what are the variants? Why these 14 countries?}
From these sequence counts, we estimate the relative fitness of each variant over time in each country, pseudo-escape rates for each variant, and pseudo-immunity for each country.
