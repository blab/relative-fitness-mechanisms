...
\begin{abstract}
    ...
    Finally, we apply these models to publicly available SARS-CoV-2 sequences in the United States.
...
Over the course of the COVID-19 pandemic, there have been several large waves of infections globally.  \cite{tegally2021detection, Volz2021} 
...
This phenomenon is consistent with antigenic evolution and is observed in several other viruses such as influenza A/H3N2 and influenza B/Yamagata \cite{Koel2013, Bedford2014}.
...
This has motivated the development of statistical methods that can take advantage of this large pool of genetic data including large scale approximate phylogenetic algorithms, identical sequence based methods, and variants frequency dynamic methods.
