...
% MF: I didn't want to introduce a delta notation but wanted to make sure that it was clear that this is the change over the period
...
% MF: Both would work here! I was just clear that the chnge in growth rate are controlled by little \psi. The total depends on the cummulative. Similar situation with relative fitness and cumulative relative fitness.
...
Our model is able to replicate patterns seen in epidemic growth rates in England derived from ONS data (Fig.~\ref{fig:selective_pressure_prediction} J--L), achieving a Spearman correlation of $R^2 = 0.328$ and mean absolute error of 0.019.
