...
%MF: This is a typo on my end. I'm using coefficient of variation / explained variance here.
...
% \tbc{Currently Fig.~\ref{fig:growth_rate_predictions_model_comparison} is never referenced in the text. I believe you want to reference it here.}V
%MF: Moved this to where we describe the model selection component. 
