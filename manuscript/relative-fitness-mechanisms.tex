...
Using case and sequence data from 50 US states between May 2021 and November 2022, we estimate epidemic growth rates in these states and as well as selective pressure using our approximate Gaussian model on sequence counts grouped at the level of Nextstrain clades (Figs.~\ref{fig:selective_pressure_east}--\ref{fig:selective_pressure_west}). 
