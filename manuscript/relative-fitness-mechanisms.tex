...
Using case and sequence data from 50 US states between January 2021 and November 2022, we estimate epidemic growth rates in these states and as well as selective pressure using our approximate Gaussian model on sequence counts grouped at the level of Nextstrain clades (Figs.~\ref{fig:selective_pressure_east}--\ref{fig:selective_pressure_west}).
...
Our model is able to replicate patterns seen in epidemic growth rates in England derived from ONS data (Fig.~\ref{fig:selective_pressure_prediction} J--L), achieving a Spearman correlation of $R^2 = 0.306$ and mean absolute error of 0.022.
...
\begin{figure}[t!]
    ...
    \caption{
      \textbf{Bootstrapping pseudo-immune distance and human titer distance analysis. $N=1,000$}
    }
